...
fn main() {
    ...
    let mut first_card = create_card();
    let mut second_card = create_card();
    let mut third_card = create_card();
    let mut fourth_card = create_card();

    let mut first_hand = vec![];
    first_hand.push(first_card);
    first_hand.push(second_card);

    let mut second_hand = vec![];
    second_hand.push(third_card);
    second_hand.push(fourth_card);
