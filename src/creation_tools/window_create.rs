...
use super::game_creation_tools::game_create::{create_game, Player};
...
pub fn window_creation() -> Result<(), Box<dyn std::error::Error>>  {
    ...
    while app.wait() {
        ...
        if let Some(msg) = r.recv() {
            ...
            match msg {
                ...
                Message::Stay => starting_players.0.dealer_draw(),
